...
<div class="content">
    ...
    <!--end 公告 -->
    <div class="mod-games">
        <div class="platform-wrap pr layout">
            <div class="hd-menu">
                <ul class="clearfix">
                    <li class="current pt-menu" target="pt-item"><h2>PT 游戏厅</h2></li>
                    <li class="mg-menu" target="mg-item"><h2>MG 游戏厅</h2></li>
                    <li class="bb-menu" target="bb-item"><h2>BB 游戏厅</h2></li>
                    <li class="ag-menu" target="ag-item"><h2>AG 游戏厅</h2></li>
					<li class="nt-menu" target="nt-item"><h2>NT 游戏厅</h2></li>
                </ul>
            </div>
...
<!-- PT电游客户端下载 -->
<?= $this->renderPartial('/game/ptClientDownload',array('pt_playername'=>$pt_playername,'name'=>'皇冠现金网')) ?>
<!-- end PT电游客户端下载 -->

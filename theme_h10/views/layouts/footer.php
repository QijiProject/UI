<!--footer-->
<div class="footer">
    <ul class="footer-contact layout">
        <li class="footer-contact-1"><i></i><span>官方邮箱<br />xpj123win@gmail.com</span></li>
        <li class="footer-contact-2"><i></i><span>简易地址<br />123.win</span></li>
        <li class="footer-contact-3"><i></i><span>微信客服<br />www123win</span></li>

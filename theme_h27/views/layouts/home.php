...
<script type="text/javascript" src="<?=$this->getCdn();?>/static/js/myScript.js"></script> 
<script type="text/javascript" src="<?=$this->getCdn();?>/static/js/jackpotMoney.js"></script>
<script type="text/javascript" src="<?=$this->getCdn();?>/static/js/jq_scroll.js"></script>
</body>
</html>
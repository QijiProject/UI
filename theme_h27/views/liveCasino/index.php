            ...
            <ul class="clearfix">
                ...
                <li class="pt-play-btn">
                    <div class="game-detail">
                        ...
                        <p class="btn">
                            <a href="javascript:void(0);" onclick="load_pt('<?=NPT::PT_LD ?>',<?=$pt_status ?>,'plba');">进入游戏</a>
                        </p>
                    </div>
                </li>
                <li class="tgp-play-btn">
                    <div class="game-detail">
                        <p class="detail">凭借稳定，流畅和创新，一直深受亚洲地区玩家喜爱</p>
                        <p class="btn">
                            <a href="javascript:void(0);" onclick="loadTPGLD(<?=$status ?>)">进入游戏</a>
                        </p>
                    </div>
                </li>
            </ul>
